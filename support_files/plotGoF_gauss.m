...
% after peer review: alternate random effects structure:
UNterm1='data ~  1+(1+ GaitQ|subjectID)'; % constant, with random intercepts per subj
UNterm2='data ~  GaitQ + (1+ GaitQ|subjectID)'; % as above, + fixed effect of alpha
UNterm3='data ~  GaitQ+GaitQ^2 + (1+ GaitQ|subjectID)';  % include quadratic term




% UNterm3='data ~  GaitQ^2 + (1+ GaitQ|subjectID)';  % include quadratic term
...
statsOUT.pvalsummary = [pval, pval2, pvalq];
