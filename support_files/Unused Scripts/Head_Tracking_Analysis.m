...
% % Add a column to hold the Quartile information for this participant
% newColumn = array2table(nan(nTotalRows, 1), 'VariableNames', {'Walk Phase'});
%
% mytab = [mytab newColumn];
...
for i= 10:15
    ...
    for j=1:(length(locs_mins)-1)
        ...
        qTimesThisStep.Participant(1:end) = 2;
